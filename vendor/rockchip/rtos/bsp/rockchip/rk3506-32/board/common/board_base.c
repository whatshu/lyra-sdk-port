...
static struct GIC_AMP_IRQ_INIT_CFG irqsConfig[] =
{
    ...
    GIC_AMP_IRQ_CFG_ROUTE(UART3_IRQn, 0xd0, CPU_GET_AFFINITY(2, 0)),
#endif
#ifdef RT_USING_I2C0
    GIC_AMP_IRQ_CFG_ROUTE(I2C0_IRQn, 0xd0, CPU_GET_AFFINITY(2, 0)),
#endif
...
#endif
    struct HAL_UART_CONFIG hal_uart3_config =
    {
        .baudRate = UART_BR_1500000,
        .dataBit = UART_DATA_8B,
        .stopBit = UART_ONE_STOPBIT,
...
#endif
    HAL_UART_Init(&g_uart3Dev, &hal_uart3_config);
