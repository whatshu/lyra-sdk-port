...
#
# Fork of vendor/rockchip/hal/project/common/GCC/Cortex-M.mk for the
# shu-sdk M0 responder.  Differences from the vendored copy:
#   - ROOT_PATH points at the vendored HAL library (../../../vendor/rockchip/hal)
#   - the Unity test harness include (build_test.mk / UNITY_INCLUDE_CONFIG_H)
#     is dropped; this project has no host-side tests
#   - the watchdog reset flag build is not needed here (no BSP_SetLoaderFlag)

ROOT_PATH	:= ../../../vendor/rockchip/hal
